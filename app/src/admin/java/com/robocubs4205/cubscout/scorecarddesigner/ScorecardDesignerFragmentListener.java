...
interface ScorecardDesignerFragmentListener {
    ...
    void GameDesignerFragmentUpButtonClicked(ScorecardDesignerFragment fragment);
    void GameDesignerFragmentDownButtonClicked(ScorecardDesignerFragment fragment);
}
